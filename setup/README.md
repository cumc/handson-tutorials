...
### Managing servers
To suspend, resume, or cancel large amount of jupyters, this same [job manager script](https://github.com/cumc/handson-tutorials/blob/main/setup/manage_jobs.py) can be used. 
```
